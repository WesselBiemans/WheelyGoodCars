...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    ...
    <form method="GET" action="{{ route('cars.index') }}" class="mb-8 bg-white rounded-lg shadow-lg p-6">
        <div class="flex flex-col gap-4">
            <div>
                <h3 class="text-lg font-semibold text-gray-900">Filter op tags</h3>
                <p class="text-sm text-gray-600">Selecteer een of meer tags om alleen passende auto's te tonen.</p>
            </div>
            ...
            <div class="flex items-center gap-3">
                ...
                <a href="{{ route('cars.index') }}" class="text-sm text-gray-600 hover:text-cyan-700">
                    Wis filter
                </a>
            </div>
        </div>
